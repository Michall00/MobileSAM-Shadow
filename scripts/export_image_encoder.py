...
parser.add_argument(
    "--checkpoint",
    type=str,
    default="weights/mobile_sam_ckpt_best_model.pt",
...
parser.add_argument(
    "--output", 
    type=str,
    default="weights/mobile_sam_image_encoder.onnx",
...
def run_export(
    ...
    if use_preprocess:
        dummy_input = {
            "input_image": torch.randn((batch_size, image_size, image_size, 3), dtype=torch.float)
        }
        dynamic_axes = {
            "input_image": {0: "batch_size", 1: "image_height", 2: "image_width"},
        }
    else:
        dummy_input = {
            "input_image": torch.randn(
                (batch_size, 3, image_size, image_size), dtype=torch.float
            )
        }
        dynamic_axes = {
            "input_image": {0: "batch_size", 2: "image_height", 3: "image_width"},
        }
